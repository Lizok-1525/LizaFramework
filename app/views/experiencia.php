<div class="container content ">
  <div class="row intro">
    <div class="col mt-3 ">
      <h2 class="mb-3">Experiencia laboral, que he tenido: </h2>
      ...
      <ul>
        ...
        <li>
          ...
          <p>Trabajaba como cajera, también en cocina y algunos días estaba como limpieza en restaurante.</p>
        </li>
        <li>
          <h3 class="fs-4">Pollos y mas, Palma, Son Fuster </h3>
          <p>Trabajaba como limpieza en restaurante, ayudaba en cocina, también como cajera. </p>
        </li>
        <li>
