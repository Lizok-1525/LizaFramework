  ...
  <div class="row ">
    ...
    <div class="col-sm-8 p-5 intro bg-light text-dark">
      ...
      <div class="p-2">
        ...
        <select class="form-select w-80 text-bg-secondary" data-bs-theme="dark">
